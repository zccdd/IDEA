...
//获取正在显示得图片，stop表示防止图片移进移出时得闪动，siblings表示获取选中元素得同级元素 eq筛选索引的一种方法
...
//   	=============
//   美丽说	导航栏
     	$('.tp5_1 .tp5_2 .tp5_2_1').click(function(){
     		
     		  n = $(this).index();//获得序号
     		  
     		$(this).addClass('tp5_2_11').siblings('.tp5_2 .tp5_2_1').removeClass('tp5_2_11'),$('.tp5_3 .tp5_4').eq(n).show().siblings().hide();
  
     	})
//   美丽说	tab切换下
     	$('.tp6_1 .tp5_2 .tp5_2_1').click(function(){
     			
     			l = $(this).index();
     			
     			$(this).addClass('tp5_2_11').siblings('.tp5_2 .tp5_2_1').removeClass('tp5_2_11'),$('.tp6_3').eq(l).show().siblings().hide();
